  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-slate-100 shadow-sm">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        <a href="#home" className="flex items-center gap-2 text-xl font-semibold text-[#1E293B] shrink-0">
          <img src="/logo.png" alt="WeRepairSubZero logo" className="h-8 w-8 object-contain" />
